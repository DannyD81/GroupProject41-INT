...
<body>
    ...
    <main class="container text-center mortgage-container">
        <h1 class="h3 fw-bold">Create Mortgage</h1>
        <h2 class="h5 mb-4">Products Available - Step 3</h2>
        ...
        <div class="mb-2">
        <a href="logged-in-home.php" class="mt-3">
             <button class="btn btn-secondary w-100 py-2">Save comparison</button>
        </a>
        </div>
        <a href="select-products.php" class="mt-3">
